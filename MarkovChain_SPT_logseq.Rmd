...
test_df4<- t(as.matrix(test_df3))
names(test_df4) <- c(1:532)
commmon_seqs2 <- colCounts(test_df4, value = "1")

barplot(commmon_seqs, names.arg = days)
barplot(commmon_seqs2, names.arg = days)
